...
import { Flex, Box, Image, Text, chakra, Icon,GridItem,VisuallyHidden,Input,SimpleGrid,} from "@chakra-ui/react";
...
<div className="">
          <Box px={8} py={24} mx="auto">
            ...
            >
              ...
              >
                A rental system is a platform that allows customers to rent items for a specific period of time.
				and it is easy to use, secure, fast, best and provide a seamless rental experience for customers 24/7.
...
>
  <Flex bg="brand.400">
    <Image
      src="https://kmslh.com/wp-content/uploads/2021/05/shutterstock_1153862578-1-scaled.jpg"
  ...
  >
    ...
    <chakra.p
      ...
      letterSpacing="wider"
    >
      Get the best customer care and start getting personalized
      experiences at every stage of the customer journey.<br/>
