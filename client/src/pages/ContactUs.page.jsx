...
import { BrandFacebook, BrandInstagram, BrandLinkedin, BrandTwitter, CurrentLocation, Mail, PhoneCall } from "tabler-icons-react";

const ContactUsPage = () => {
	
	return (
		<div className="">
			<div className="bg-[url('https://cdn.sanity.io/images/za5m6yef/production/46152070cc2faf24d3f035d2ade2426da25a5361-960x600.jpg?rect=0,67,960,465&w=930&h=450&blur=50')] bg-cover bg-no-repeat bg-center h-screen">
				{/* This is homepage */}
