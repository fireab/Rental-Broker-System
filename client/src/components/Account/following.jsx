...
const Following = () => {
	...
	const { following, refetchFollowing, isFollowingLoading, isFollowingFetching } = useUser(username);

	useEffect(() => {
		refetchFollowing();
	}, [refetchFollowing]);

	if (isFollowingLoading || isFollowingFetching || !following) {
		return <div>Loading...</div>;
	}

	console.log(following, "something");
